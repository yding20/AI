...
public class DecisionTreeLearner {
	...
	public DecisionTreeLearner(DecisionTree tree, Integer iter, Integer tit) throws Exception {
		...
		if (tit == 2) {
			initialdataSet = new DataSetInitial("car.data.txt", 3);
		}
	...
	public void train() {
		...
		// This part is for test accuray vs the number of trainset
	...
	public DecisionTree decisionTreeLearning(List<String[]> dataSet, List<String> attributes, List<String[]> dataSetPre) {
		...
		if (dataSet.isEmpty()){
			...
			// System.out.println("END Reason: Data is Empty and Decision is : " + s);
			// System.out.println();
		...
		if (sameClassification(dataSet)) {
			...
			// System.out.println("END Reason: TargetValueSame and Decision is : " + s);
			// System.out.println();
			return new ConstantDecisonTree(s);
		}
		...
		if (attributes.isEmpty()){
			...
			// System.out.println("END Reason: Attributes is Empty and Decision is : " + s);
			// System.out.println();
			return new ConstantDecisonTree(s);
		}
...
// Above part : Calculating Entropy gain
	...
	public static void main(String[] args) throws Exception {
		DecisionTree tree = new DecisionTree(); 
		 ...
		 // for (int i = 1; i < 2; i++) {
		 // 	DecisionTreeLearner example = new DecisionTreeLearner(tree, i, 0);
		 // 	example.train();
		 // 	//System.out.println("###Training Finished###");
	
		 // 	List<String[]> testdataSet = new ArrayList<>();
	
		 // 	File file = new File("AIMA_Restaurant-data.txt"); 
		 ...
		 for (int i = 1; i < 2; i++) {
		 	...
		 	File file = new File("iris.data.discrete_test.txt"); 
		 	BufferedReader br = new BufferedReader(new FileReader(file)); 
		 	...
		 	System.out.println("The accuracy on iris.data_test :  \t" + 1.0 * correct / total);
		 }
		...
		for (int i = 1; i < 2; i++) {
			...
			File file = new File("car.data_test.txt"); 
			BufferedReader br = new BufferedReader(new FileReader(file)); 
			...
			System.out.println("The accuracy on car.data_test : \t" + 1.0 * correct / total);
		}
