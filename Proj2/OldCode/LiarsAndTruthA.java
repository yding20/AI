...
public class LiarsAndTruthA {
	...
	public LiarsAndTruthA(String s) {
		symbols.add("Amy");
		symbols.add("Bob");
		symbols.add("Cal");
		...
		KBPre.add(and1);
		Iff iff1 = new Iff("Amy", and1.toString());
		KB.add(iff1);

		NegationSymbol n1 = new NegationSymbol("Cal");
		KBPre.add(n1);
		iff1 = new Iff("Bob", n1.toString());
		KB.add(iff1);

		n1 = new NegationSymbol("Amy");
		KBPre.add(n1);
		Or or1 = new Or("Bob", n1.toString());
		KBPre.add(or1);
		iff1 = new Iff("Cal", or1.toString());
		KB.add(iff1);
